...
| Item | Status | Notes |
|------|--------|-------|
| M5 Goods Movement Posting | ⚠️ Partial | PI BAPIs implemented, pending OIH01/OIH10 IS-OIL config by Basis team |
| VCF Calculation | ⚠️ Partial | Using factor 1.0 (ASTM fallback) — needs Hydrocarbon Qty Conversion API URL |
