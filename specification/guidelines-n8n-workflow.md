...
- If calling CAP APIs: use a placeholder URL like `[REDACTED] If calling SAP APIs directly: use a placeholder URL like `https://your-s4hana-host.example.com/sap/opu/odata/sap/`
